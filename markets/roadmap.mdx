...
| **XAG** | Silver | Jun 2026 |
| **NVDA** | NVIDIA | Jun 2026 |
| **AAPL** | Apple | Jun 2026 |
| **OIL** | WTI crude oil | Jun 2026 |
| **EUR** | EUR/USD | Jun 2026 |

Eight markets, ~$11.5M TVL, all on 0.10% native bin-book pools. See [Live markets](/markets/live) for full pubkeys. (VXX was delisted in June 2026.)
...
_(NVDA and AAPL are now live.)_

### Commodities
- BRENT (Brent crude)
- HG (Copper)

_(XAG silver and OIL/WTI are now live.)_
...
- **Funding rate.** The constant-product NAV invariant replaces it for positioning; the short leg's [volatility decay](/concepts/nav#volatility-decay) covers the pair's convexity.
...
- **In-house AMM.** Shipped in v2: native per-side bin books + committed orders are the live trading venue.
