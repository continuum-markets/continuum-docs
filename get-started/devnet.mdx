...
Eight markets are currently active on devnet. Full pubkeys (mints, pools, oracle configs) are in [Live markets](/markets/live).
...
| `XAG` | Silver | `VETzCeHk2mobTaUATNRBcokKE3x8YrcRyGx3Vsz4prr` | `DnHSia6WX5jYPnRkSTfu4GtbrTw2CAdLWKRmdMsWPHU3` |
| `NVDA` | NVIDIA | `B8M3y6wHGFZidqYciVxGu27KYk2dLcqgBGNoUDXMVzNN` | `6n525VkawSkm6h1HxisHCpRssdbmazb1Q9S3Bi2f9emL` |
| `AAPL` | Apple | `7ofckkctk9wUpTn77zFv8t8yb3iBUSkuU3vmcXbaUboS` | `438bLh6shsVHXoQwtaRP56zWuAsLJK1o2u6FyRe6crYV` |
| `OIL` | WTI crude oil | `HcCmSMfBdNh1XhphBKiDYb3Vk8dgCsYyuEBXiSDnY4Eh` | `ADHvHu51SS5CiM9TTkDo3RGxkhgsShcywGzNEDndLBJ7` |
| `EUR` | EUR/USD | `FLDQtZ2adGWTcawQh6jziufJejkexoPA2uYimQTqA8z9` | `z5u5UYz5jWdbycMexwdYvkw56fLY1uvx5RZW3EtxRsM` |
