...
| [`clp`](/programs/clp) | `8xauDRjw9XRyk4FE3hW1JKjD8nC87gfr59Xig1dJqLES` | Capital and Liquidity Provider - vaults, Meteora DLMM proxy. |
...
For trading L/S directly (not at NAV), use Meteora DLMM SDK - see [Trade](/flows/trade).
