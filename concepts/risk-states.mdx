...
| `ProxyMode` | Pricing off keeper-relayed TWAP (devnet default) | ✅ | ✅ | NAV + 1.5× confidence markup |
...
- **The bin books keep trading** inside the last posted band. Off-hours price discovery happens here.
...
Operate normally. Quotes carry a 1.5× confidence markup on mint - usually a few bps. If you're a bot, note that NAV freshness is bounded by the keeper's ~15 s push cadence.
