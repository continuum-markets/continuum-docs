...
| **Book manager** | 30s | Re-pins each pool's base to NAV when drift exceeds the per-market gate (20bps for indices/metals, wider for single names), posting the vol-scaled, skewed bin shape. See [Book management](/keeper/book-management). |
