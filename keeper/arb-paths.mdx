...
<Note>
  The v1 arb scanner - four mint/redeem-vs-Meteora cycles racing external pools back to NAV - is retired along with Meteora. In v2 the venues are the protocol's own, and the peg is maintained structurally rather than by trading against it.
</Note>
